...
void Gear_Ratios::process_exercise(const QString &filePath) {
...
int Gear_Ratios::process_task_one(const QString &line) {

    return result_task_one;
}

int Gear_Ratios::process_task_two(const QString &line) {
