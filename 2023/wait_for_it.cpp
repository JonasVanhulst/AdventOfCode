...
void Wait_For_It::process_exercise(const QString &filePath) {
...
int Wait_For_It::process_task_one(const QString &line) {

    return result_task_one;
}

int Wait_For_It::process_task_two(const QString &line) {
